  ...
  getEpisode: protectedProcedure
    ...
    .query(async ({ input, ctx }) => {
      ...
      return {
        ...
        title: episode.title,
        src: process.env.MEDIA_SERVER_LINK + "/videos" + episode.src,
        subSrc: process.env.MEDIA_SERVER_LINK + "/subs" + episode.src,
        preiewsSrc: process.env.MEDIA_SERVER_LINK + "/previews" + episode.src,
        rating: episode.rating,
        id: episode.id,
        duration: episode.duration,
        previewsAmount: episode.previewsAmount,
