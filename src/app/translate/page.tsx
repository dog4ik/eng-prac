    ...
    <>
      ...
      <div className="mt-5 flex flex-1 flex-col items-center gap-5">
        <div className="flex w-full items-center justify-center">
          <div className="flex flex-col justify-center divide-y-2 rounded-xl border bg-white px-5 py-2 text-black md:w-2/3 md:flex-row md:divide-x-2 md:divide-y-0">
